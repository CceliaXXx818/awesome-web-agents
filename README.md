...
- [BOSS Job Agent](https://github.com/CceliaXXx818/boss-job-agent) - Open-source Chrome job-search agent that plans, evaluates, replans, and performs policy-bounded recruiter outreach on BOSS Zhipin. ![GitHub Repo stars](https://img.shields.io/github/stars/CceliaXXx818/boss-job-agent?style=social)
